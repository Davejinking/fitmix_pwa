...
/// Analysis Page with Workout Heatmap Integration
class AnalysisPageWithHeatmap extends StatefulWidget {
  const AnalysisPageWithHeatmap({super.key});

  @override
  State<AnalysisPageWithHeatmap> createState() => _AnalysisPageWithHeatmapState();
}

class _AnalysisPageWithHeatmapState extends State<AnalysisPageWithHeatmap> {
                  ...
                  : SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          // Additional analysis sections can go here
